...
import { ListenersPod } from '../Data/podcast'
import {Link} from 'react-router-dom'
function ListenersChoice() {
    const pods = ListenersPod.map(pods =>(
  ...
  return (
    <div className='ml-16'>
        <h1 className='text-white font-bold text-2xl '>Listeners Choice</h1>
...
export default ListenersChoice